      ...
      <Host>
        {element === 'detail' ? (
          ...
          <meetings-editor
            ...
            oncancel-clicked={() => navigate('./entry/' + entryId)}
            api-base={this.apiBase}
          ></meetings-editor>
        ) : element === 'creator' ? (
          <meetings-creator oncreator-closed={() => navigate('./list')} oncancel-clicked={() => navigate('./list')} api-base={this.apiBase}></meetings-creator>
        ) : (
          <meetings-list
            api-base={this.apiBase}
