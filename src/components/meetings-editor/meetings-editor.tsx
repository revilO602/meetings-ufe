...
export class MeetingsEditor {
  ...
  private async updateEntry() {
    ...
    if (this.isValid) {
      try {
        const response = await MeetingsListApiFactory(undefined, this.apiBase).updateMeeting(this.entryId, this.entry);
        if (response.status < 299) {
  ...
  private async deleteEntry() {
    try {
      const response = await MeetingsListApiFactory(undefined, this.apiBase).deleteMeeting(this.entryId);
      if (response.status < 299) {
